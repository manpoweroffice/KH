    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/KH/jun/multiplePhotoUpload.do'; 	//다중파일 업로드 URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : "/KH/jun/photoUpload.do",	//파일 업로드시 동작되는 컨트롤러 URL
 	        sCallback :'/KH/resources/naverEditor/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
