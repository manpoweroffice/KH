...
function setKinds1(kinds){
	var kind = kinds;
	document.getElementById("kinds1").value=kind;s
...
<form action="education.do" enctype="multipart/form-data" method="post">
		 <table id="ta" border="1" width="1000" cellpadding="0" cellspacing="0" align="center"> 
			<tr height="40">
				<td align="center" width="500"><p>교육과목</p></td>
				<td align="center" width="500"><p>교육기관</p></td>
				<td align="center" width="300"><p>교육내용</p></td>
				<td align="center" width="300"><p>기간</p></td>
			</tr>
